    ...
    <div className="bg-gradient-to-r overflow-hidden from-slate-900 to-slate-950 py-8 md:py-10 lg:py-12 text-2xl text-white font-mono ">
      <div className="w-[95vw] md:w-[90vw] lg:w-[85vw] mx-auto">
        ...
        <div className="text-xl md:text-3xl mt-5 mb-5">
          ...
          I also want to explore the world of IOT. Also I believe on multiverse 😁
        </div>
        <div>
        ...
        <div className="font-thin mt-5 ">
          ...
          <Project url="#" name="Linkedin Clone"
             techstack={{
              frontend:"React JS",
              backend:"Firebase",
              database:"Firestore",
            ...
            <Project url="#" name="Ecommerce Site"
             techstack={{
              frontend:"React JS",
              api:"fakeapi.platzi",
            ...
            <Project url="#" name="Recipe App"
             techstack={{
            frontend:"React JS",
            api:"themealdb"
            }} />

            <Project url="#" name="Quiz Game"
             techstack={{
              other:"HTMl CSS & JS"
            }} />
        ...
        <div className="flex items-center gap-x-2 ">
          <a href="https://www.instagram.com/mustafa_shf_/" className="rounded-md hover:bg-white duration-100" target="_blank">
            <svg
          ...
          <a
            href="https://pk.linkedin.com/in/mustafashf"
            target="_blank"
          ...
          <a href="https://github.com/MustafaShf" target="_blank" className="rounded-md hover:bg-white duration-100">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
